--[[====================================================
      Fly + NoClip + ESP GUI (PC & Mobile) by FokusID
======================================================]]
...
local function randomString()
    local str = ""
    for i = 1, 10 do str = str .. string.char(math.random(97, 122)) end
    return str
end
...
local function sFLY(vfly)
    ...
    flyKeyDown = IYMouse.KeyDown:Connect(function(KEY)
        ...
        elseif QEfly and KEY=="q" then CONTROL.E=-(vfly and vehicleflyspeed or iyflyspeed)*2 end
    end)
...
local function mobilefly(speaker,vfly)
    unmobilefly(speaker) FLYING=true
    local root=getRoot(speaker.Character)
    ...
    mfly2=RunService.RenderStepped:Connect(function()
        ...
        if speaker.Character:FindFirstChildWhichIsA("Humanoid") and root and root:FindFirstChild(velocityHandlerName) and root:FindFirstChild(gyroHandlerName) then
            ...
            GyroHandler.CFrame=camera.CFrame VelocityHandler.Velocity=v3none
...
local function removeESP(player)
    for _,obj in pairs(espFolder:GetChildren()) do
        if obj.Name=="ESP_"..player.Name then obj:Destroy() end
    end
end
